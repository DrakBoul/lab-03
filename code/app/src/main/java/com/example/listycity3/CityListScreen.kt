    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        if (showAddCityFields or showUpdateCityFields) {
            Row(
                ...
                Button(
                    ...
                    onClick = {
                        if (newCityName.isNotBlank() and newProvinceName.isNotBlank()) {
                            ...
                            if (showUpdateCityFields and (selectedCity != null)) {
                                onUpdateCity(
                                    selectedCity!!,
                                    City(
                                        name = newCityName,
        ...
        LazyColumn(modifier = Modifier.fillMaxSize()) {
            itemsIndexed(cities) { index, city ->
                CityRow(city = city, modifier = Modifier.clickable(onClick = {
